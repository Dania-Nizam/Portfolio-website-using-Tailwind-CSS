  ...
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-10 md:pl-40 pb-10 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px] w-full">
          ...
          <p className="text-gray-200 text-lg hidden md:block">
            Passionate frontend web developer with a flair for creating
            engaging user experiences and clean, maintainable code.
          </p>
      ...
      {/* <div className="absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5 w-full px-5">
        <Link
          href="/my-skills"
          className="rounded-[20px] group bg-blue-500 px-5 py-3 text-lg text-white w-full"
        >
          Learn more
        </Link>
        ...
        <Link
          href="/my-projects"
          className="rounded-[20px] group bg-transparent border border-white px-5 py-3 text-lg text-white w-full"
        >
          My projects
        </Link>
        <Link
